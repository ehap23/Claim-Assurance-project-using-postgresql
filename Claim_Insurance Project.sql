...
-- Define tables: Customers , Policies , Claims , PolicyTypes.
        -- Include Fields such as customerID, PolicyID, PolicyTypeID, Claimamount, 
		-- ClaimDate, etc.
...
-- i choose the Claim Date columns because i think one of the most frequently used column
